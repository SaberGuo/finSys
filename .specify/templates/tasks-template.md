...
**Tests**: Testing tasks are REQUIRED. Every user story MUST include failing-first
...
- Tasks MUST be executable with explicit dependencies and independently verifiable
  completion criteria
...
- [ ] T004 [P] Configure and verify test tooling (unit + integration/contract)
...
- [ ] T020 [P] [US2] Unit test for [core behavior] in tests/unit/test_[name].py
...
- [ ] T027 [P] [US3] Unit test for [core behavior] in tests/unit/test_[name].py
...
- [ ] TXXX [P] Coverage and regression hardening in tests/unit/ and tests/integration/
